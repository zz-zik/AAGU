"""
Two-Feature Attention Module
Mostly copy-paste from (https://github.com/Violette-py/CrowdCounting-P2PNet/models/TFAM.py)
"""
...
if __name__ == '__main__':
    ...
    model = TFAM(in_channel=80)
    print(model(torch.randn(1, 512, 64, 80), torch.randn(1, 512, 64, 80)).shape)
    flops, params = profile(model, inputs=(torch.randn(1, 512, 64, 80), torch.randn(1, 512, 64, 80)))
    # 输出模型的FLOPs和参数量
